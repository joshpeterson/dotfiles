...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'tsx', 'typescript', 'vimdoc', 'vim', 'tablegen', 'julia' },
...
vim.keymap.set('n', '<leader>bd', require('bufdel').delete_buffer_expr, { desc = '[B]uffer [D]elete' })
